...
#ifndef XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
#define XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
...
#endif  // XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
