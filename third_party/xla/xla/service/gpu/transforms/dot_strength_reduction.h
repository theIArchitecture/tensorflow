...
#ifndef XLA_SERVICE_GPU_TRANSFORMS_DOT_STRENGTH_REDUCTION_H_
#define XLA_SERVICE_GPU_TRANSFORMS_DOT_STRENGTH_REDUCTION_H_
...
#endif  // XLA_SERVICE_GPU_TRANSFORMS_DOT_STRENGTH_REDUCTION_H_
