...
class FusedMatMulBiasAddMulAddEluTest : public GrapplerTest {
 public:
  ...
  void RunTest() {
    ...
    auto addv2_in2 =
        Placeholder(s.WithOpName("addv2_in2"), DTYPE, addv2_in2_shape);
    auto lhs = Placeholder(s.WithOpName("lhs"), DTYPE, lhs_shape);
    auto rhs = Placeholder(s.WithOpName("rhs"), DTYPE, rhs_shape);
    auto bias = Placeholder(s.WithOpName("bias"), DTYPE, bias_shape);
...
TEST_F(FusedMatMulBiasAddMulAddEluTest, fp32) { RunTest<DT_FLOAT>(); }
TEST_F(FusedMatMulBiasAddMulAddEluTest, bf16) { RunTest<DT_BFLOAT16>(); }
TEST_F(FusedMatMulBiasAddMulAddEluTest, fp16) { RunTest<DT_HALF>(); }
