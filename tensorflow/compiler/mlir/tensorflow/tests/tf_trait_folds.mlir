...
func.func @testSingleConj(%arg0: tensor<complex<f32>>) -> tensor<complex<f32>> {
...
// CHECK-SAME:  ([[ARG0:%.+]]: tensor<complex<f32>>)
func.func @testDoubleConj(%arg0: tensor<complex<f32>>) -> tensor<complex<f32>> {
  %0 = "tf.Conj"(%arg0) : (tensor<complex<f32>>) -> tensor<complex<f32>>
...
func.func @testSingleReciprocal(%arg0: tensor<i32>) -> tensor<i32> {
...
// CHECK-SAME:  ([[ARG0:%.+]]: tensor<i32>)
func.func @testDoubleInvert(%arg0: tensor<i32>) -> tensor<i32> {
  %0 = "tf.Invert"(%arg0) : (tensor<i32>) -> tensor<i32>
...
// CHECK-SAME:  ([[ARG0:%.+]]: tensor<i32>)
func.func @testSingleNeg(%arg0: tensor<i32>) -> tensor<i32> {
...
// CHECK-SAME:  ([[ARG0:%.+]]: tensor<i32>)
func.func @testTripleNeg(%arg0: tensor<i32>) -> tensor<i32> {
  // CHECK: [[NEG:%.+]] = "tf.Neg"([[ARG0]])
  %0 = "tf.Neg"(%arg0) : (tensor<i32>) -> tensor<i32>
  %1 = "tf.Neg"(%0) : (tensor<i32>) -> tensor<i32>
...
func.func @testSingleLogicalNot(%arg0: tensor<i1>) -> tensor<i1> {
...
// CHECK-SAME:  ([[ARG0:%.+]]: tensor<i1>)
func.func @testDoubleLogicalNot(%arg0: tensor<i1>) -> tensor<i1> {
  %0 = "tf.LogicalNot"(%arg0) : (tensor<i1>) -> tensor<i1>
